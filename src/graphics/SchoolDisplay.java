...
public class SchoolDisplay {
    ...
    public static final String schoolData = new File(new File(System.getProperty("java.class.path")).getAbsolutePath()).getParent() + "/json/School.json"; // Mandatory location for the school json data
    public static final String userData = new File(new File(System.getProperty("java.class.path")).getAbsolutePath()).getParent() + "/json/User.json"; // Mandatory location for the user specific json data
