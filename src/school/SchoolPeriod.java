...
| -startDayAdjust: TimeData                                                                           |
| -endDayAdjust: TimeData                                                                             |
+-----------------------------------------------------------------------------------------------------+
| +SchoolPeriod(int, String, String, String, boolean, SchoolClass)                                    |
| +SchoolPeriod(int, String, String, String, boolean, SchoolClass, String)                            |
+-----------------------------------------------------------------------------------------------------+
| -getStringTimeComponents(String, boolean, boolean, String): TimeData                                |
| +getPeriod(): int                                                                                   |
| +getName(): String                                                                                  |
| +getStartTime(): String                                                                             |
| +getEndTime(): String                                                                               |
| +getClassInfo(): SchoolClass                                                                        |
| +getPeriodDescription(): String                                                                     |
| +getStartDayAdjust(): TimeData                                                                      |
| +getEndDayAdjust(): TimeData                                                                        |
| +toString(): String                                                                                 |
+-----------------------------------------------------------------------------------------------------+
...
public class SchoolPeriod {
    ...
    private TimeData getStringTimeComponents(String stringTime, boolean isEndTime, boolean endOfDayAdjust, String errorMessage) throws Exception {
        ...
        if (endOfDayAdjust) {
            return new TimeData(0, SchoolCalendar.hoursPerDay - 1, SchoolCalendar.minutesPerHour - 1, SchoolCalendar.secondsPerMinute - 1, SchoolCalendar.millisecondsPerSecond - 1);
        }
        ...
        return new TimeData(0, hours, minutes, SchoolCalendar.secondsPerMinute - 1, SchoolCalendar.millisecondsPerSecond - 1);
    }
