...
|                                           SchoolCalendar                                            |
+-----------------------------------------------------------------------------------------------------+
| +getPeriodTerm: String                                                                              |
| +getNameTerm: String                                                                                |
| +getRoomNumberTerm: String                                                                          |
| +getTeacherNameTerm: String                                                                         |
| +getStartTimeTerm: String                                                                           |
| +getEndTimeTerm: String                                                                             |
| +getCommentTerm: String                                                                             |
| +getAdjustTerm: String                                                                              |
| +getWeekTagTerm: String                                                                             |
| +getWeeksTerm: String                                                                               |
| +getDaysTerm: String                                                                                |
| +getInfoTerm: String                                                                                |
| +getUserTerm: String                                                                                |
| +getSettingsTerm: String                                                                            |
| +getNextUpTerm: String                                                                              |
| +getThemeTerm: String                                                                               |
| +getFreePeriodTerms: ArrayList<Sting>                                                               |
| +getFirstPeriod: String                                                                             |
| +getLastPeriod: String                                                                              |
| +getFirstDate: String                                                                               |
| +getLastDate: String                                                                                |
| +get_DEFAULT_WEEK: String                                                                           |
| +dateTimeFormat: String                                                                             |
| +dayIndexToName: String[]                                                                           |
| +weeksPerYear: int                                                                                  |
| +daysPerWeek: int                                                                                   |
| +hoursPerDay: int                                                                                   |
| +minutesPerHour: int                                                                                |
...
| +fakePeriod: int                                                                                    |
| +freePeriod: int                                                                                    |
| -firstStringDate: String                                                                            |
| -lastStringDate: String                                                                             |
| -firstEpochDate: Calendar                                                                           |
| -lastEpochDate: Calendar                                                                            |
| -firstWeekendDate: Calendar                                                                         |
| -lastWeekendDate: Calendar                                                                          |
| +schoolYear: SchoolYear                                                                             |
| -schoolClassArray: ArrayList<SchoolClass>                                                           |
| -schoolPeriodArray: HashMap<String, ArrayList<SchoolPeriod>>                                        |
| -dayTagArray: ArrayList<String>                                                                     |
| -schoolDayHashMap: HashMap<String, SchoolDay>                                                       |
| -weekTagArray: ArrayList<String>                                                                    |
| -schoolWeekHashMap: HashMap<String, SchoolWeek>                                                     |
+-----------------------------------------------------------------------------------------------------+
| +SchoolCalendar(String, String)                                                                     |
+-----------------------------------------------------------------------------------------------------+
| +instantiateClassObjects(): void                                                                    |
| +instantiatePeriodObjects(): void                                                                   |
| +getFirstPeriod(): int                                                                              |
| +getLastPeriod(): int                                                                               |
| +getFirstWeekendDate(): Calendar                                                                    |
| +getSchoolYear(): SchoolYear                                                                        |
| +getFirstDayOfWeek(Calendar): Calendar                                                              |
| +getLastDayOfWeek(Calendar): Calendar                                                               |
| +getDayTag(Calendar): String                                                                        |
| +advanceToFutureDay(Calendar, int): void                                                            |
| +getPeriodByTimeAndDate(Calendar): PeriodData                                                       |
| -getNextPeriodThisDay(PeriodData, boolean, boolean): PeriodData                                     |
| +getNextPeriod(PeriodData): PeriodData                                                              |
| +getNextPeriod(PeriodData, boolean): PeriodData                                                     |
| +getNextPeriod(PeriodData, boolean, boolean): PeriodData                                            |
| +calculateTimeLeft(long, long): TimeData                                                            |
| +calculateTimeLeft(long, long, boolean): TimeData                                                   |
| +getTimeRemainingInPeriod(Calendar, SchoolPeriod): TimeData                                         |
| +getTimeRemainingUntilPeriod(Calendar, SchoolDay, SchoolPeriod): TimeData                           |
| +getTimeRemainingUntilPeriod(Calendar, SchoolDay, SchoolPeriod, boolean): TimeData                  |
| +toString(): String                                                                                 |
+-----------------------------------------------------------------------------------------------------+
...
public class SchoolCalendar {
    ...
    public static final String getAdjustTerm = "Adjust";
    ...
    private final ArrayList<String> weekTagArray; // An array of week tag strings in format yyyy-mm-dd
    private final HashMap<String, SchoolWeek> schoolWeekHashMap; // A hashmap with keys as week tags and values as the SchoolWeek object for that week
    ...
    // ====================================================================================================
    // public PeriodData getPeriodByDateAndTime
    //
    ...
    // Returns--
    //
    // The period that overlaps with epochDate
    //
    public PeriodData getPeriodByDateAndTime(Calendar epochDate) throws Exception {
        ...
        for (int i = 0; i < day.getPeriodList().size(); i++) {
            ...
            startTime.set(Calendar.HOUR_OF_DAY, period.getStartDayAdjust().getHours()); // Set the hours to the start time of the period
            startTime.set(Calendar.MINUTE, period.getStartDayAdjust().getMinutes()); // Set the minutes to the start time of the period
            startTime.set(Calendar.SECOND, period.getStartDayAdjust().getSeconds());
            ...
            if (epochDate.getTime().getTime() >= startTime.getTime().getTime() && epochDate.getTime().getTime() <= endTime.getTime().getTime()) {
                ...
                return new PeriodData(day, period, i);
            }
        }
    ...
    // end: public PeriodData getPeriodByDateAndTime


    // ====================================================================================================
    // private PeriodData getNextPeriodThisDay
    //
    ...
    //
    private PeriodData getNextPeriodThisDay(PeriodData lastMatch, boolean matchOnlyRealPeriod, boolean matchOnlyPeriodWithClass) {
        SchoolDay dayObj = lastMatch.getDay(); // Get the day object from the last period match
        int periodIndex = lastMatch.getIndex(); // Get the period index from the last match


        PeriodData match = null; // Initialize a new hashmap to add to and return later
    ...
    // end: private PeriodData getNextPeriodThisDay


    // ====================================================================================================
    // public PeriodData getNextPeriod
    //
    ...
    //
    public PeriodData getNextPeriod(PeriodData lastMatch) throws Exception {
        return this.getNextPeriod(lastMatch, false);
    }
    // end: public PeriodData getNextPeriod
    ...
    //
    public PeriodData getNextPeriod(PeriodData lastMatch, boolean matchOnlyRealPeriod) throws Exception {
    ...
    //
    public PeriodData getNextPeriod(PeriodData lastMatch, boolean matchOnlyRealPeriod, boolean matchOnlyPeriodWithClass) throws Exception {
        ...
        PeriodData findMatch = new PeriodData(lastMatch.getDay(), lastMatch.getPeriod(), lastMatch.getIndex() + 1);
        ...
        for (int i = 0; i < runawayCounter; i++) {
            ...
            PeriodData match = getNextPeriodThisDay(findMatch, matchOnlyRealPeriod, matchOnlyPeriodWithClass);
            if (match != null) { return match; }

            // If the next period match was not found, then the day needs to be advanced
            SchoolDay dObj = findMatch.getDay(); // Update the school day object
            ...
            findMatch = new PeriodData(dayMatch, null, 0);
        }
    ...
    // ====================================================================================================
    // public TimeData calculateTimeLeft
    //
    ...
    //
    public TimeData calculateTimeLeft(long startTimeMS, long endTimeMS) {
        return this.calculateTimeLeft(startTimeMS, endTimeMS, false);
    }
    // end: public TimeData> calculateTimeLeft
    ...
    //
    public TimeData calculateTimeLeft(long startTimeMS, long endTimeMS, boolean convertDaysToHours) {
        long deltaMilliseconds = endTimeMS - startTimeMS; // Get the difference in ms time between the start and end times

        int ms = 0, days = 0, hours = 0, minutes = 0, seconds = 0;

        // Check that there is not a negative time left
        if (deltaMilliseconds >= 0) {
            ms = (int) deltaMilliseconds;

            days = (int) Math.floor(deltaMilliseconds / (SchoolCalendar.msPerDay * 1.0));
            deltaMilliseconds -= (long) days * SchoolCalendar.msPerDay; // Subtract the number of days in ms from the total ms value

            hours = (int) Math.floor(deltaMilliseconds / (SchoolCalendar.msPerHour * 1.0));
            deltaMilliseconds -= (long) hours * SchoolCalendar.msPerHour; // Subtract the number of hours in ms from the total ms value

            minutes = (int) Math.floor(deltaMilliseconds / (SchoolCalendar.msPerMinute * 1.0));
            deltaMilliseconds -= (long) minutes * SchoolCalendar.msPerMinute; // Subtract the number of minutes in ms from the total ms value

            seconds = (int) Math.floor(deltaMilliseconds / (SchoolCalendar.msPerSecond * 1.0));

            // Check if days should be converted to hours
            if (convertDaysToHours) {
                hours += days * SchoolCalendar.hoursPerDay;
                days = 0;
            }
        }

        // Return the time left hashmap object
        return new TimeData(days, hours, minutes, seconds, ms);
    }
    // end: public TimeData calculateTimeLeft


    // ====================================================================================================
    // public TimeData getTimeRemainingInPeriod
    //
    ...
    //
    public TimeData getTimeRemainingInPeriod(Calendar epochDate, SchoolPeriod period) throws Exception {
        ...
        endTime.set(Calendar.HOUR_OF_DAY, period.getEndDayAdjust().getHours()); // Set the hours to the period end hours
        endTime.set(Calendar.MINUTE, period.getEndDayAdjust().getMinutes()); // Set the minutes to the period end minutes
        endTime.set(Calendar.SECOND, period.getEndDayAdjust().getSeconds()); // Set the seconds to the period end seconds
    ...
    // end: public TimeData getTimeRemainingInPeriod


    // ====================================================================================================
    // public TimeData getTimeRemainingUntilPeriod
    //
    ...
    //
    public TimeData getTimeRemainingUntilPeriod(Calendar epochDate, SchoolDay day, SchoolPeriod period) throws Exception {
        return this.getTimeRemainingUntilPeriod(epochDate, day, period, false);
    }
    // end: public TimeData getTimeRemainingUntilPeriod
    ...
    //
    public TimeData getTimeRemainingUntilPeriod(Calendar epochDate, SchoolDay day, SchoolPeriod period, boolean convertDaysToHours) throws Exception {
        ...
        periodStart.set(Calendar.HOUR_OF_DAY, period.getStartDayAdjust().getHours()); // Set the hours to the start of the next period
        periodStart.set(Calendar.MINUTE, period.getStartDayAdjust().getMinutes()); // Set the minutes to the start of the next period
        periodStart.set(Calendar.SECOND, period.getStartDayAdjust().getSeconds()); // Set the seconds to the start of the next period

        // Return the remaining time
        return this.calculateTimeLeft(epochDate.getTime().getTime(), periodStart.getTime().getTime(), convertDaysToHours);
    }
    // end: TimeData getTimeRemainingUntilPeriod
